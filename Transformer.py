...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, trg_vocab_size, src_pad_idx, trg_pad_idx, embed_size=512,
                 num_layers=6, forward_expansion=4, heads=8, dropout=0, device="cpu", max_len=100):
        super.__init__()
        # Encoder = TransformerBlock*num_layers
        ...
        # Decoder = DecoderBlock*num_layers = (Attention+TransformerBlock)*num_layers
